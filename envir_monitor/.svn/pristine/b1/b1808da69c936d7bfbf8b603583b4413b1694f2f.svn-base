package com.mwm.test.apachecommons;
...
public class lang {
	...
	public static void main(String args[]) throws ParseException{
		...
		System.out.println(StringEscapeUtils.escapeJavaScript("测试'测试哦"));//"\u6D4B\u8BD5\'\u6D4B\u8BD5\u54E6"  
		...
		boolean result11 = ArrayUtils.contains(array5, "bbb"); // => true       
		System.out.println(result1);//true  
		  
		// 判断某元素在数组中出现的位置（从前往后，没有返回-1）  
		int result22 = ArrayUtils.indexOf(array5, "bbb"); // => 1       
