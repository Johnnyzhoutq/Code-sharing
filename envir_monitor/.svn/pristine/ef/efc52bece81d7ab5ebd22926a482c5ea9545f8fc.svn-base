...
public class DateUtil {
	...
	public static Date getDateAfterMonth(Date date, int duration) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
	...
	/**
	 * 获取今天的日期yyyy-MM-dd格式 时分秒是实时的    getTodayYMDDate是去掉时分秒的
	 *
	 * @return
	 */
	...
	/**
	 * 本月第一天   *配合DateUtil.clearDateAfterDay去掉时分秒
	 */
	...
	/**
	 * 本周第一天,周日     *配合DateUtil.clearDateAfterDay去掉时分秒
	 */
	...
	/** 
	 * @Title: getOnedayOfWeek 
	 * @Description: 本周第num天   *配合DateUtil.clearDateAfterDay去掉时分秒
	 * @param date
	 * @param num 1:周日     2：周一     3：周二     7:周六
	 * @return Date
	 */ 
	public static Date getOnedayOfWeek(Date date,int num) {
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
	...
	public static void main(String[] args) {
		...
		if(calendar.get(Calendar.DAY_OF_WEEK)>6){
			date=DateUtil.clearDateAfterDay(DateUtil.getOnedayOfWeek(new Date(),6));
		}else{
			calendar.add(Calendar.DATE, -7);
			date=DateUtil.clearDateAfterDay(DateUtil.getOnedayOfWeek(calendar.getTime(),6));
		}
		System.out.println(DateUtil.clearDateAfterDay(DateUtil.getOnedayOfWeek(calendar.getTime(),6)));
//		Calendar calendar = Calendar.getInstance();
//		calendar.setTime(new Date());
//		calendar.add(Calendar.DATE, -7);
//		System.out.println(DateUtil.formatDate(calendar.getTime(),"yyyy-MM-dd HH:mm:ss"));
//		System.out.println(DateUtil.formatDate(DateUtil.clearDateAfterDay(getOnedayOfWeek(new Date(),9)),"yyyy-MM-dd HH:mm:ss"));
	}
}
