...
public class JavascriptUtil {
	...
	public static final int LEVEL_DEBUGGABLE = COMPRESS_STRIP_SL_COMMENTS | COMPRESS_STRIP_ML_COMMENTS
			| COMPRESS_TRIM_LINES;
	...
	public static String shrinkVariableNames(String text) {
		...
		// throw new UnsupportedOperationException("Variable name shrinking is
		// not supported");
	}
	...
	private static final String[] RESERVED_ARRAY = new String[] {
			...
			"abstract", "debugger", "enum", "goto", "implements", "interface", "native", "protected", "synchronized",
			...
			// I have seen the folowing list as 'best avoided for function
			// names'
			// but it seems way to all encompassing, so I'm not going to include
			// it
			/*
			 * "alert", "anchor", "area", "arguments", "array", "assign",
			 * "blur", "boolean", "button", "callee", "caller", "captureevents",
			 * "checkbox", "clearinterval", "cleartimeout", "close", "closed",
			 * "confirm", "constructor", "date", "defaultstatus", "document",
			 * "element", "escape", "eval", "fileupload", "find", "focus",
			 * "form", "frame", "frames", "getclass", "hidden", "history",
			 * "home", "image", "infinity", "innerheight", "isfinite",
			 * "innerwidth", "isnan", "java", "javaarray", "javaclass",
			 * "javaobject", "javapackage", "length", "link", "location",
			 * "locationbar", "math", "menubar", "mimetype", "moveby", "moveto",
			 * "name", "nan", "navigate", "navigator", "netscape", "number",
			 * "object", "onblur", "onerror", "onfocus", "onload", "onunload",
			 * "open", "opener", "option", "outerheight", "outerwidth",
			 * "packages", "pagexoffset", "pageyoffset", "parent", "parsefloat",
			 * "parseint", "password", "personalbar", "plugin", "print",
			 * "prompt", "prototype", "radio", "ref", "regexp", "releaseevents",
			 * "reset", "resizeby", "resizeto", "routeevent", "scroll",
			 * "scrollbars", "scrollby", "scrollto", "select", "self",
			 * "setinterval", "settimeout", "status", "statusbar", "stop",
			 * "string", "submit", "sun", "taint", "text", "textarea",
			 * "toolbar", "top", "tostring", "unescape", "untaint", "unwatch",
